...
const Login = () => {
  ...
  return (
    ...
    >
      <div className="container-login p-5 d-flex flex-column">
        ...
        <form className>
          ...
          <span className="d-flex flex-column flex-wrap">
            ...
            <Divider>O</Divider>
            <Button icon={<Icon component={botonGoogle} className="p-1" />}>
              Inicie sesión con Google
            </Button>
          </span>
        </form>

        <Link to="/" className="ant-btn ant-btn-primary mt-5 p-1">
